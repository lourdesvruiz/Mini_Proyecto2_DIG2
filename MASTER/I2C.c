...
unsigned char MPU_Master_Write(unsigned char data)
{
    I2C_Master_Wait();
    SSPBUF = data;
...
{ 
    SSPADD = address;
    SSPCON = 0x36;      // 0b00110110 SSPEN, CKP, I2C slave mode, direccion de 7 bits
    SSPSTAT = 0x80;     // 0b10000000 SMP (Slew rate desactivado, 100kHz, 1MHz)
    SSPCON2 = 0x01;     // 0b00000001 Clock stretching habilitado
    TRISC3 = 1;
    TRISC4 = 1;
    GIE = 1;
    PEIE = 1;
